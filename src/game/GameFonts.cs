    ...
    internal static class GameFonts
    {
        ...
        internal static TMP_FontAsset HeavyFont
        {
            get
            {
                ...
                {
                    PlantPeekPlugin.Log.LogWarning($"Heavy font lookup failed: {e.Message}");
                }
        ...
        private static void Search()
        {
            ...
            {
                PlantPeekPlugin.Log.LogWarning($"Font lookup failed, falling back to TMP default: {e.Message}");
            }
        }
    }
}
